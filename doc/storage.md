...
Почему не сделать как [Bootstrap dashboard](https://themes.getbootstrap.com/product/hyper-responsive-admin-dashboard-template/)?
...
- нет разделения на разные приложения и все настройки в одном месте (возможно делать разделение внутри приложения)
