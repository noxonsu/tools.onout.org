...
- подключить **cf pages** для автодеплоя

## Как собрать, задеплоить и настроить смарт контракты?

### Сборка

В README.md репозитория контрактов есть интсрукция по их сборке.
...
- отправить транзакцию через провайдер: **Web3js** или **Ethers**
