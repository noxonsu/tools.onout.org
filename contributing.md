...
## 0.1 Нужно переименовать репозиторий так как будет называтся будущий проект. Название не так важно и должно отображать суть продукта, делать его очень просто, выбираем одну основную фукнцию-действие которую пользователь совершает в продукте и вставляем сюда https://namelix.com/, понравивашееся название берем и все. 
