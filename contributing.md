...
- зависимое существует из-за уникальных частей. В этих частях нам необходимо автоматизировать изменения (т.е. дать возможность админу вносить эти изменнения из админки в вебе, чтоб он не лазил в исходники), а сам обьем и кол-во таких частей сделать минимальным. То есть чтобы клиент/админ мог изменять все сам, а нам не пришлось добавлять/менять большое кол-во кода для каждого нового требования.
