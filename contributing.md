...
В примере с Uniswap V2 из зависимого у нас есть множество файлов с импортами `@uniswap/sdk` пакета или констант с адресами и номерами сетей. Сам `@uniswap/sdk` уникален, так как в нем так же есть данные для конкретного блокчейна. Для начала нужно сократить кол-во зависимостей.
